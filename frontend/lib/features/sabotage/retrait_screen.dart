...
class _RetraitScreenState extends ConsumerState<RetraitScreen> {
  ...
  Future<void> _submit() async {
    ...
    final amount = toHtgAmount(double.parse(_amountCtrl.text.trim()), settings);
    ...
    if (amount > _selectedClient!.balance) {
      setState(() => _error =
          'Solde insuffisant (disponible : ${formatMoney(_selectedClient!.balance, settings)})');
      return;
    }
    setState(() {
      _loading = true;
          ...
          child: Column(
            ...
            children: [
              ...
              if (_selectedClient != null) ...[
                ...
                Text('Solde disponible : ${formatMoney(_selectedClient!.balance, settings)}',
