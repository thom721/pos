...
def public_platform_config(
    ...
    return {
        ...
        "renewal_price_per_caisse_htg": _f(cfg.renewal_price_per_caisse_htg),
        "renewal_price_per_caisse_usd": _f(cfg.renewal_price_per_caisse_usd),
        "renewal_price_per_depot_htg":  _f(cfg.renewal_price_per_depot_htg),
        "renewal_price_per_depot_usd":  _f(cfg.renewal_price_per_depot_usd),
